...
export const MedicineDoses = ({ onClose }) => {
    const initialMedicineState = {
        name: '',
        pills: '',
        time: '',  // Changed from doses to time
        fromDate: null,
        toDate: null,
        conditions: ''
    };
    ...
    const handleChange = (index, field, value) => {
        ...
        if (field === 'time') {
            ...
            const hours = timeValue[0].padStart(2, '0');
            const minutes = timeValue[1].padStart(2, '0');
    ...
    const handleSubmit = () => {
        ...
        const hasData = medicines.some(medicine =>
            medicine.name || medicine.pills || medicine.time || medicine.fromDate || medicine.toDate
        );
